...
export default function ReportDesigner({
  ...
  const [footerText, setFooterText] = useState("Generated by VIZI");
  ...
  const [editorTab, setEditorTab] = useState(() => normalizeEditorTab(initialEditorTab));
  ...
  useEffect(() => {
    if (!lockEditorTab) return;
    const locked = normalizeEditorTab(initialEditorTab);
    if (editorTab !== locked) setEditorTab(locked);
  }, [lockEditorTab, initialEditorTab, editorTab]);
  ...
  function applyLayoutFor(reportId) {
    const all = loadLayouts();
    const layout = all[String(reportId)] || {};
    setHeaderText(String(layout.headerText || "Production Report"));
    setSubHeaderText(String(layout.subHeaderText || ""));
    setFooterText(String(layout.footerText || "Generated by VIZI"));
    setHeaderFormat(
  ...
  function newReport() {
    ...
    setSubHeaderText("");
    setFooterText("Generated by VIZI");
...
<html>
  ...
  async function upsertDatasetFromCurrentSource(nameOverride = "") {
    try {
      ...
      if (activeReportId && nextDatasets.length) {
        saveLayoutFor(activeReportId, {
  ...
  return (
    !designerReady ? (
      <div className="report-designer-root" style={{ position: "fixed", inset: 0, background: "var(--bg)", color: "var(--text)", overflow: "hidden" }}>
        <style>{`
          @media print {
        ...
        <div
          ...
          style={{ height: "100%", display: "grid", gridTemplateColumns: `${editorWidth}px 8px 1fr`, gap: 0, padding: 0, boxSizing: "border-box" }}
        >
          <div data-print-panel="editor" style={{ border: "1px solid var(--border)", borderRadius: 0, background: "var(--bg-elev)", display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0 }}>
            <div style={{ padding: "12px 12px 0", fontSize: 18, fontWeight: 800, marginBottom: 10 }}>Report Designer</div>
    ...
    <div className="report-designer-root" style={{ position: "fixed", inset: 0, background: "var(--bg)", color: "var(--text)", overflow: "hidden" }}>
      <div style={{ height: "100%", display: "grid", gridTemplateColumns: `${editorWidth}px 8px 1fr`, gap: 0, padding: 0, boxSizing: "border-box" }}>
        <div style={{ border: "1px solid var(--border)", borderRadius: 0, background: "var(--bg-elev)", display: "flex", flexDirection: "column", overflow: "hidden", minHeight: 0, minWidth: 0 }}>
          ...
          <div style={{ display: "grid", gap: 8, padding: "0 12px 12px", overflowY: "auto", overflowX: "hidden", minHeight: 0, flex: "1 1 auto", position: "relative", minWidth: 0 }}>
            {editorTab === "datasets" ? (
              <div
                style={{
                  position: "absolute",
                ...
                <div style={{ display: "grid", gap: 8, minWidth: 0 }}>
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap", minWidth: 0 }}>
                    ...
                    <button
                      ...
                      style={{ border: "1px solid var(--border)", background: "var(--bg-soft)", color: "var(--text)", borderRadius: 8, padding: "8px 10px", cursor: "pointer", fontSize: 12, fontWeight: 700, whiteSpace: "nowrap" }}
                    >
                      New
                    </button>
                    <button
                      ...
                      style={{ border: "1px solid #f04438", background: selectedDatasetId ? "#f04438" : "rgba(240,68,56,0.35)", color: "white", borderRadius: 8, padding: "8px 10px", cursor: selectedDatasetId ? "pointer" : "not-allowed", fontSize: 12, fontWeight: 700, whiteSpace: "nowrap" }}
                    >
                      Delete
                    </button>
                  </div>
                  <input
                    ...
                    style={{ border: "1px solid var(--border)", background: "var(--bg-soft)", color: "var(--text)", borderRadius: 8, padding: "8px 10px", minWidth: 0 }}
                  />
                  <select
                    value={sourceMode}
                  ...
                  {sourceMode === "table" ? (
                    <div style={{ border: "1px solid var(--border)", borderRadius: 8, padding: 8, display: "grid", gap: 8, background: "var(--bg-soft)", minWidth: 0 }}>
                      <select
                        value={selectedTable}
                        onChange={(e) => setSelectedTable(e.target.value)}
                        style={{ border: "1px solid var(--border)", background: "var(--bg-elev)", color: "var(--text)", borderRadius: 8, padding: "8px 10px", minWidth: 0 }}
                      >
                  ...
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    <button
                      ...
                      style={{ border: "1px solid #12b76a", background: "#12b76a", color: "white", borderRadius: 8, padding: "8px 12px", cursor: "pointer", fontSize: 12, fontWeight: 700, whiteSpace: "nowrap" }}
                    >
                      Save Dataset
                    </button>
                    {selectedDatasetId ? (
          ...
          >
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              <button
                ...
                style={{ border: "1px solid #2b6cff", background: "#2b6cff", color: "white", borderRadius: 8, width: 34, height: 34, padding: 0, cursor: "pointer", fontSize: 15, fontWeight: 700 }}
              >
                {running ? (
              ...
              <button
                ...
                style={{ border: "1px solid #12b76a", background: "#12b76a", color: "white", borderRadius: 8, width: 34, height: 34, padding: 0, cursor: "pointer", fontSize: 15, fontWeight: 700 }}
              >
                {saving ? (
                  <span style={{ fontSize: 15, lineHeight: 1 }}>…</span>
                ) : (
              ...
              <button
                ...
                style={{
                  ...
                  background: !activeReportId || deleting ? "rgba(240,68,56,0.35)" : "#f04438",
                  color: "white",
                  borderRadius: 8,
                  width: 34,
                  height: 34,
                  ...
                  opacity: !activeReportId || deleting ? 0.7 : 1,
                  fontSize: 15,
                  fontWeight: 700,
                }}
              ...
              <button
                ...
                title={selectedWidgetId ? "Delete Selected Layout Table" : "Select a layout table first"}
                aria-label="Delete selected layout table"
                style={{
                  border: "1px solid #f04438",
                  background: selectedWidgetId ? "#f04438" : "rgba(240,68,56,0.35)",
                  color: "white",
                  borderRadius: 8,
                  width: 34,
                  height: 34,
                  ...
                  opacity: selectedWidgetId ? 1 : 0.7,
                  fontSize: 15,
                  fontWeight: 700,
                }}
              >
              ...
              <button
                ...
                style={{ border: "1px solid var(--border)", background: "var(--bg-soft)", color: "var(--text)", borderRadius: 8, width: 34, height: 34, padding: 0, cursor: "pointer", fontSize: 15, fontWeight: 700 }}
              >
                <Icon>
